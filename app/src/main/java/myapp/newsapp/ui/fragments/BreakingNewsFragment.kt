...
import myapp.newsapp.adapters.NewsAdapter
import myapp.newsapp.db.ArticleDatabase
import myapp.newsapp.repository.MainRepository
import myapp.newsapp.ui.MainActivity
import myapp.newsapp.utils.Constants
import myapp.newsapp.utils.Constants.Companion.QUERY_PAGE_SIZE
import myapp.newsapp.utils.Constants.Companion.SEARCH_NEWS_TIME_DELAY
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsAdapter.setOnItemClickListener {
            ...
            findNavController().navigate(
                R.id.breakingNewsFragment_to_article_fragment,
                bundle
            )
        }
